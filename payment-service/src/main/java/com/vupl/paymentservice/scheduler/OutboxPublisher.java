package com.vupl.paymentservice.scheduler;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.vupl.paymentservice.entity.OutboxEvent;
import com.vupl.paymentservice.repository.OutboxEventRepository;
    ...
    public void publishPendingEvents() {
        ...
        for (OutboxEvent event : events) {
            try {
                ...
                log.info("Published [{}] aggregateId={}", event.getEventType(), event.getAggregateId());
            } catch (Exception e) {
